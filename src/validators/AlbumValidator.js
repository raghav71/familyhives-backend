...
module.exports = () => {
  ...
  const validateMemory = async (req, res, next) => {
    ...
    const v = new Validator(req.body, {
      ...
      feed_type: validations.general.requiredString,
  ...
  const validateDeleteAlbumFile = async (req, res, next) => {
    console.log("validateDeleteAlbumFile111");
    console.log(req.body);
    const v = new Validator(req.body, {
      id: validations.albumFile.id,
      memoryId: validations.albumFile.memoryId
    });
