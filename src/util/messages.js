module.exports = (lang = 'en') => {
    ...
    const email_verified = {
        ...
        "sa":"सफलतया ईमेल इति सत्यापितः",
        "ta":"மின்னஞ்சல் வெற்றிகரமாக சரிபார்க்கப்பட்டது!",
        "gu":"ઇમેઇલ સફળતાપૂર્વક ચકાસાયેલ!"
    }
    ...
    const like_already_added_on_comment = {
    ...
    const like_already_added_on_recipe = {
    ...
    const fame_home_added = {
        "en": "Fam home added successfully!",
        "hi":"Fam home सफलतापूर्वक जोड़ी गई",
        "sa":"Fam home added successfully",
        "ta":"Fam home added successfully",
        "gu":"Fam home added successfully"
    }

    const fame_home_updated = {
        "en": "Fam home updated successfully!",
        "hi":"Fam home सफलतापूर्वक अपडेट की गई",
        "sa":"Fam home updated successfully",
        "ta":"Fam home updated successfully!",
        "gu":"Fam home updated successfully!"
    }
...
// Alarm message
    ...
    const enter_either_id_or_language = {
    ...
    const wish_comments_added = {
        "en": "Comments on greetings saved successfully!",
        "hi":"शुभकामना संदेश पर आई टिप्पणियां (कमेंट) सफलतापूर्वक सेव की गईं",
        "sa":"Comments on greetings saved successfully",
        "ta":"வாழ்த்துகள் பற்றிய கருத்துகள் வெற்றிகரமாக சேமிக்கப்பட்டன",
        "gu":"શુભેચ્છાઓ પરની ટિપ્પણીઓ સફળતાપૂર્વક સાચવવામાં આવીે"
    }

    const wish_comments_updated = {
        "en": "Comments on greetings updated successfully!",
        "hi":"शुभकामना संदेश पर आई टिप्पणियां (कमेंट) सफलतापूर्वक अपडेट की गईं",
        "sa":"Comments on greetings updated successfully",
        "ta":"வாழ்த்துகள் பற்றிய கருத்துகள் வெற்றிகரமாக புதுப்பிக்கப்பட்டன",
        "gu":"વશુભેચ્છાઓ પરની ટિપ્પણીઓ સફળતાપૂર્વક અપડેટ થઈ"
    }

    const wish_comments_deleted = {
        "en": "Comments on greetings deleted successfully!",
        "hi":"शुभकामना संदेश पर आई टिप्पणियां (कमेंट) सफलतापूर्वक हटाई गईं",
        "sa":"Comments on greetings deleted successfullyा",
        "ta":"வாழ்த்துகள் பற்றிய கருத்துகள் வெற்றிகரமாக நீக்கப்பட்டனு",
        "gu":"શુભેચ્છાઓ પરની ટિપ્પણીઓ સફળતાપૂર્વક કાઢી નાખવામાં આવી"
    }

    const wish_like_added = {
        "en": "greetings liked!",
        "hi":"शुभकामना संदेश पसंद/लाइक की गई",
        "sa":"greetings likedा",
        "ta":"வாழ்த்துக்கள் பிடித்திருந்தது",
        "gu":"શુભેચ્છાઓ ગમ્યું"
    }

    const like_updated_on_wish = {
        "en": "Like on greetings updated!",
        "hi":"शुभकामना संदेश पर आई पसंद/लाइक को अपडेट किया गया",
        "sa":"Like on greetings updated",
        "ta":"லைக் ஆன் வாழ்த்துகள் புதுப்பிக்கப்பட்டது",
        "gu":"લાઈક ઓન ગ્રીટિંગ્સ અપડેટ"
    }
    const group_image_updated = {
        "en": "Group image updated successfully",
        "hi":"समूह छवि सफलतापूर्वक अपडेट की गईं",
        "sa":"Group image updated successfully",
        "ta":"குழுப் படம் வெற்றிகரமாக புதுப்பிக்கப்பட்டது",
        "gu":"જૂથ છબી સફળતાપૂર્વક અપડેટ થઈ"
    }

    const ablum_file_deleted = {
        "en": "Album file deleted successfully",
        "hi":"एल्बम फ़ाइल सफलतापूर्वक हटाई गई",
        "sa":"Album file deleted successfully",
        "ta":"ஆல்பம் கோப்பு வெற்றிகரமாக நீக்கப்பட்டது",
        "gu":"આલ્બમ ફાઇલ સફળતાપૂર્વક કાઢી નાખી"
    }
    ...
    return {
        ...
        content_list:content_list[lang],
        user_details:user_details[lang],
        album_details:album_details[lang],
        album_added:album_added[lang],
        memory_added:memory_added[lang],
        memory_updated:memory_updated[lang],
        fame_home_added:fame_home_added[lang],
        fame_home_updated:fame_home_updated[lang],
        album_deleted:album_deleted[lang],
        memory_deleted:memory_deleted[lang],
        memory_comments_added:memory_comments_added[lang],
        memory_comments_updated:memory_comments_updated[lang],
        memory_comments_deleted:memory_comments_deleted[lang],
        memory_like_added:memory_like_added[lang],
        memories_list:memories_list[lang],
        user_logout:user_logout[lang],
        wish_added:wish_added[lang],
        wish_updated:wish_updated[lang],
        wish_deleted:wish_deleted[lang],
        wish_list:wish_list[lang],
        kahani_added:kahani_added[lang],
        kahani_updated:kahani_updated[lang],
        kahani_privacy_changed:kahani_privacy_changed[lang],
        kahani_list:kahani_list[lang],
        kahani_comments_added:kahani_comments_added[lang],
        kahani_comments_updated:kahani_comments_updated[lang],
        kahani_comments_deleted:kahani_comments_deleted[lang],
        kahani_like_added:kahani_like_added[lang],
        kahani_deleted:kahani_deleted[lang],
        alarm_added:alarm_added[lang],
        alarm_updated:alarm_updated[lang],
        alarm_deleted:alarm_deleted[lang],
        alarm_list:alarm_list[lang],
        FAQs_added:FAQs_added[lang],
        FAQs_deleted:FAQs_deleted[lang],
        FAQs_status_changed:FAQs_status_changed[lang],
        family_member_added:family_member_added[lang],
        main_member_already_added:main_member_already_added[lang],
        spouse_member_already_added:spouse_member_already_added[lang],
        family_member_updated:family_member_updated[lang],
        member_removed:member_removed[lang],
        request_sent: request_sent[lang],
        request_already_sent: request_already_sent[lang],
        request_list: request_list[lang],
        request_accepted: request_accepted[lang],
        request_rejected: request_rejected[lang],
        friends_list:friends_list[lang],
        individual_chat_list:individual_chat_list[lang],
        group_created:group_created[lang],
        group_image_updated:group_image_updated[lang],
        group_details:group_details[lang],
        group_list:group_list[lang],
        group_data_missing:group_data_missing[lang],
        chat_saved:chat_saved[lang],
        chat_exist:chat_exist[lang],
        participant_removed:participant_removed[lang],
        participant_blocked:participant_blocked[lang],
        participant_unblocked:participant_unblocked[lang],
        chat_cleared:chat_cleared[lang],
        friend_blocked:friend_blocked[lang],
        friend_unblocked:friend_unblocked[lang],
        ...
        family_tree_switched:family_tree_switched[lang],
        family_tree:family_tree[lang],
        family_tree_updated:family_tree_updated[lang],
        member_mobile_exist:member_mobile_exist[lang],
        spouse_mobile_exist:spouse_mobile_exist[lang],
        relation_updated:relation_updated[lang],
        channel_removed:channel_removed[lang],
        family_tree_removed:family_tree_removed[lang],
        token_generated:token_generated[lang],
        feed_list:feed_list[lang],
        no_family_tree_found:no_family_tree_found[lang],
        ...
        wish_comments_added:wish_comments_added[lang],
        wish_comments_updated:wish_comments_updated[lang],
        wish_comments_deleted:wish_comments_deleted[lang],
        wish_like_added:wish_like_added[lang],
        like_updated_on_wish:like_updated_on_wish[lang],
        email_verified:email_verified[lang],
        ablum_file_deleted:ablum_file_deleted[lang],
    }
}
